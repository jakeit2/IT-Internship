...
public class InGameMenu2 : MonoBehaviour
{
    ...
    public GameObject WhiteTable;
    public GameObject WallShelf1;
    public GameObject Hanger1;
    public GameObject TablesWithHanger;
    public GameObject GlassShelf;
    public GameObject WoodRoundTable;
    public GameObject MetalRoundTable;
    public GameObject Counter1;
    public GameObject Counter2;
    public GameObject TriangleHanger;
    public GameObject OverHangShelf;
    public GameObject LargeTableWithShelves;
    public GameObject TableWithShelves;
    public GameObject FrameWithMannequinns;
    public GameObject MetalShelf;
    public GameObject WhiteShelf;
    public GameObject TallShelf;
    public GameObject TallTableWithMannequinn;
    public GameObject WhiteTableWithDrawers;
    public GameObject WhiteTableWithGlassTableOnTop;
    public GameObject GlassRack1;
    public GameObject Hanger3;
    public GameObject DoubleShelf;
    public GameObject PullOutShelf1;
    public GameObject PullOutShelf2;
    public GameObject GlassRack2;
    public GameObject LongHanger;
    public GameObject Hanger2;
    public GameObject Mannequinn;
    public GameObject WallShelf2;
    public GameObject DoubleTable;
    public GameObject WiderShelf;
    public GameObject WallShelf3;
